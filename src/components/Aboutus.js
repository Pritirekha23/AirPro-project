...
import AbtUsimg from '../assets/AbtUsimg.jpg'
...
function Aboutus() {
    return (
        ...
        //         </Typography>
        //         <Typography className='aboutus-page-heading '>PRODUCTS</Typography>
        //         <Typography >
        ...
        //         <Typography className='aboutus-page-heading '> SERVICES</Typography>
        ...
        <Grid className="aboutus-main-container">
            <Grid container  className="abt-firsthead "  >
                {/* <img src={AbtUsimg} alt="aboutusimg" /> */}
                <Grid  item xs={6} className="abt-first-head-text" >
                ...
                <Grid  item xs={6}  className="abt-first-head-img">
